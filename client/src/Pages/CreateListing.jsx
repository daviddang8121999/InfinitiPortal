      ...
      <form className='flex flex-col sm:flex-row gap-4'>
        <div className='flex flex-col gap-4 flex-1'>
          ...
          <div className='flex flex-wrap gap-6'>
            ...
            <div className='flex items-center gap-2'>
              <input type='number' id='regPrice' min='1' max='10' required className='p-3 border border-gray-300 rounded-lg' />
        ...
        <div className='flex flex-col flex-1 gap-4'>
          ...
          <div className='flex gap-4' >
            ...
            <button type='button' disabled={uploading} onClick={handleSubmit} className='p-3 text-green-700 border border-green-700 rounded uppercase hover:shadow-lg disabled:opacity-80'>
          ...
          <p className='text-red-700 text-sm'>{imageUploadError && imageUploadError}</p>
          {
            formData.imageURLs.length > 0 && formData.imageURLs.map((urls, index) => (  
              <div key={urls} className='flex justify-between p-3 border items-center'>
                ...
                <button type='button' onClick={() => handleDeleteImg(index)} className='p-3 text-red-700 uppercase hover:opacity-75'>Delete</button>
              </div>
            ))
          }
          <button className='uppercase p-3 bg-slate-700 rounded-lg text-white hover:opacity-95'>Create Listing</button>
        </div>
